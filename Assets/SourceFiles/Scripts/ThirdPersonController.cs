        ...
        private void Start()
{
    ...
    _fallTimeoutDelta = FallTimeout;
        ...
        private void rightclick() {
            if (Input.GetMouseButtonDown(1) || Input.GetKey("w")) {

                float y = cameraa.transform.eulerAngles.y;

                // Parent rotates only on Y
                playerobj.transform.rotation = Quaternion.Euler(0f, y, 0f);
            }
        }
...
//            }
            ...
            if (Input.GetKey("w")) {
                Vector3 targetDirection = Quaternion.Euler(0.0f, y, 0.0f) * Vector3.forward;
